...
#. Verify that the application loads and Products/Stores can be added and deleted.
...
#. Return to **Prism Central** and select :fa:`bars` **> Policies > Security Policies >**\ *Initials*-**Fiesta**.
